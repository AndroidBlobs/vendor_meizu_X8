...
LOCAL_MODULE_OWNER := meizu
LOCAL_SRC_FILES := proprietary/vendor/app/SSGCredentialService/SSGCredentialService.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
...
include $(CLEAR_VARS)
LOCAL_MODULE := TelephonyEngineerMode
LOCAL_MODULE_OWNER := meizu
LOCAL_SRC_FILES := proprietary/vendor/app/TelephonyEngineerMode/TelephonyEngineerMode.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
